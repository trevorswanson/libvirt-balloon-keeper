...
class WebTests(unittest.TestCase):
    ...
    def test_native_page_uses_loopback_api_without_shell_writes(self):
        ...
        self.assertIn('id="lbk-remove"', content)
        self.assertIn("Remove deletes this VM from the keeper configuration", content)
        self.assertIn("Existing state and decision history will be retained", content)
        self.assertIn("removed.configured=false", content)
        self.assertIn("Remove "+"'+(selected.id||selected.domain)", content)
    ...
    def test_manifest_is_immutable_and_integrity_pinned(self):
        ...
        self.assertIn("<!ENTITY sha256    \"a97c924dc15109cf3829c125b288e1bfcd4b2056374415744fe4e5c9dbeebddc\">", manifest)
